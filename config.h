...
static Color colors[] = {
/*
	[DEFAULT] = { .fg = COLOR_BLACK, .bg = -1, .fg256 = -1, .bg256 = -1, },
*/
...
#define NORMAL_ATTR     (COLOR(DEFAULT) | A_BOLD)
...
const char tags[][8] = { "FS", "PFMED", "FMSET"};
...
static KeyBinding bindings[] = {
	...
	{ { MOD, 't', '0'      }, { tag,            { NULL }                    } },
	{ { CTRL('f'),         }, { create,         { "fmset", "FMSET" }        } },
	{ { CTRL('p'),         }, { create,         { "pfmed", "PFMED" }        } },
	{ { CTRL('q'),         }, { quit,           { NULL }                    } },
	{ { CTRL('t'),         }, { create,         { NULL }                    } },
...
static Button buttons[] = {
	// { BUTTON4_PRESSED,        { mouse_focus,      { NULL  } } },
	// { BUTTON5_PRESSED,        { mouse_focus,      { NULL  } } },
...
static Action actions[] = {
	{ create, { "oprin",  "Operator Input", NULL} },  // bottom left 
	{ create, { "erchk", "Errors", NULL } }, //bottom right
	{ create, { "monit5", "Recorder Status", NULL } }, //top right
	{ create, { "monit2", "Station Status", NULL } }, //top left
	{ create, { "monan", "Antenna Status", NULL } },  // right
	{ create, { "fsclient -n -s", "Log", NULL } }, // first center
	{ focusn, { "1", NULL }},
};

//static Action actions[] = {
//	{ create, { "oprin",  "Operator Input", NULL} },  // bottom left 
//	{ create, { "bash", "Errors", NULL } }, //bottom right
//	{ create, { "bash", "Recorder Status", NULL } }, //top right
//	{ create, { "bash", "Station Status", NULL } }, //top left
//	{ create, { "bash", "Antenna Status", NULL } },  // right
//	{ create, { "less dvtm.c", "Log", NULL } }, // first center
//	{ focusn, { "1", NULL }},
//};
